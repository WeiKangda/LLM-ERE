...
if __name__ == "__main__":
    ...
    docs = []
    if args.test: 
        output_dir = "./llm/output/gpt4_iterative_prediction/test"
    else:
        output_dir = "./llm/output/gpt4_iterative_prediction/valid"
            ...
            if relation == "coreference":
                ...
                for j, sentence in enumerate(doc["sentences"]):
                    if j >= len(example_doc["sentences"]) - 1:
                        prompt_context = example_doc["coref_context_inputs"][-1]
                ...
                for j, sentence in enumerate(doc["sentences"]):
                    if j >= len(example_doc["sentences"]) - 1:
                        prompt_context = example_doc["temporal_context_inputs"][-1]
                ...
                for j, sentence in enumerate(doc["sentences"]):
                    if j >= len(example_doc["sentences"]) - 1:
                        prompt_context = example_doc["causal_context_inputs"][-1]
